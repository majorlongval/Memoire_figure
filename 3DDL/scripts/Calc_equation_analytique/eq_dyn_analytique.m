...
vect1 = cross(a11,p-b1m)';
vect2 = cross(a12,p-b1m)';
vect3 = cross(a21,p-b2m)';
vect4 = cross(a22,p-b2m)';
vect5 = cross(a31,p-b3m)';
vect6 = cross(a32,p-b3m)';

Mat = ([vect1;vect2;vect3;vect4;vect5;vect6]);
test = null(Mat');
...
% detM = simplify(det(M'));
% 
% adjM = simplify(adjoint(M));
% 
% sol_test = simplify(adjM/detM);
% 
...
% cond_eq = (cond*gamma);
% 
% test1 = simplify(cond_eq(1)+cond_eq(2));
% test2 = simplify(cond_eq(3)+cond_eq(4));
% test3 = simplify(cond_eq(5)+cond_eq(6));
% 
% 
% 
% 
