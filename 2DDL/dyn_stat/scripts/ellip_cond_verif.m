...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
verif1 = rt <= -(Psi_1*(m*g+tors(1))-Omega_1*tors(2)+D_1*tors(3))*...
               theta_1/(d_11^2+d_21^2);
verif2 = rt <= -(Psi_2*(m*g+tors(1))-Omega_2*tors(2)+D_2*tors(3))*...
               theta_2/(d_12^2+d_22^2);
verif3 = rt <= -(Psi_3*(m*g+tors(1))-Omega_3*tors(2)+D_3*tors(3))*...
